  ...
  <section id="design" class="relative bg-brand-card overflow-hidden py-24 md:py-36 px-5 sm:px-8 md:px-16 lg:px-24 border-t border-brand-border">
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        <div class="reveal-item bg-brand-dark p-8 md:p-10 border border-brand-border hover:border-white transition-colors duration-500 flex flex-col">
          ...
          <div class="mt-8 pt-5 border-t border-brand-border">
            <a href="{{ route('services.branding') }}" class="group inline-flex items-center gap-3 font-body text-xs text-brand-orange tracking-[0.2em] uppercase font-medium hover:text-white transition-colors duration-300">
        ...
        <div class="reveal-item bg-brand-dark p-8 md:p-10 border border-brand-border hover:border-white transition-colors duration-500">
          ...
          <div class="mt-8 pt-5 border-t border-brand-border">
            <a href="{{ route('services.website-design') }}" class="group inline-flex items-center gap-3 font-body text-xs text-brand-orange tracking-[0.2em] uppercase font-medium hover:text-white transition-colors duration-300">
              <span>Learn More</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        <div class="reveal-item bg-brand-card p-8 md:p-10 border border-brand-border hover:border-white transition-colors duration-500">
          ...
          <div class="mt-8 pt-5 border-t border-brand-border">
            <a href="{{ route('services.architectural-visualization') }}" class="group inline-flex items-center gap-3 font-body text-xs text-brand-orange tracking-[0.2em] uppercase font-medium hover:text-white transition-colors duration-300">
              <span>Learn More</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>
        ...
        <div class="reveal-item bg-brand-card p-8 md:p-10 border border-brand-border hover:border-white transition-colors duration-500">
          ...
          <div class="mt-8 pt-5 border-t border-brand-border">
            <a href="{{ route('services.product-visualization') }}" class="group inline-flex items-center gap-3 font-body text-xs text-brand-orange tracking-[0.2em] uppercase font-medium hover:text-white transition-colors duration-300">
              <span>Learn More</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        <div class="reveal-item bg-brand-dark p-8 md:p-10 border border-brand-border hover:border-white transition-colors duration-500">
          ...
          <div class="mt-8 pt-5 border-t border-brand-border">
            <a href="{{ route('services.seo') }}" class="group inline-flex items-center gap-3 font-body text-xs text-brand-orange tracking-[0.2em] uppercase font-medium hover:text-white transition-colors duration-300">
              <span>Learn More</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>
        ...
        <div class="reveal-item bg-brand-dark p-8 md:p-10 border border-brand-border hover:border-white transition-colors duration-500">
          ...
          <div class="mt-8 pt-5 border-t border-brand-border">
            <a href="{{ route('services.digital-marketing') }}" class="group inline-flex items-center gap-3 font-body text-xs text-brand-orange tracking-[0.2em] uppercase font-medium hover:text-white transition-colors duration-300">
              <span>Learn More</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        <div class="reveal-item bg-brand-card p-8 md:p-10 border border-brand-border hover:border-white transition-colors duration-500">
          ...
          <div class="mt-8 pt-5 border-t border-brand-border">
            <a href="{{ route('services.ar-vr-experiences') }}" class="group inline-flex items-center gap-3 font-body text-xs text-brand-orange tracking-[0.2em] uppercase font-medium hover:text-white transition-colors duration-300">
              <span>Learn More</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>
        ...
        <div class="reveal-item bg-brand-card p-8 md:p-10 border border-brand-border hover:border-white transition-colors duration-500">
          ...
          <div class="mt-8 pt-5 border-t border-brand-border">
            <a href="{{ route('services.interactive-display') }}" class="group inline-flex items-center gap-3 font-body text-xs text-brand-orange tracking-[0.2em] uppercase font-medium hover:text-white transition-colors duration-300">
              <span>Learn More</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>

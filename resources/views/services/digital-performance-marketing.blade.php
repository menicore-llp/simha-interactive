...
<head>
  ...
  <title>Digital & Performance Marketing - Simha Interactive</title>
...
<body>
  ...
  <section class="relative bg-brand-dark overflow-hidden pt-40 pb-20 md:pt-52 md:pb-36 px-5 sm:px-8 md:px-16 lg:px-24 min-h-[90vh] flex items-center">
    ...
    <div class="absolute right-0 md:right-8 top-1/2 -translate-y-1/2 font-display text-white pointer-events-none select-none hidden lg:block"
         style="font-size: clamp(16rem, 22vw, 28rem); opacity: 0.018; line-height: 1; letter-spacing: -0.05em;">D</div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto w-full">
      <div class="flex flex-col items-center text-center gap-7 max-w-4xl mx-auto">
        ...
        <div class="reveal-item flex items-center justify-center gap-3" style="transition-delay: 60ms;">
          ...
          <span class="font-body text-xs text-brand-orange tracking-[0.4em] uppercase font-medium">Digital &amp; Performance Marketing</span>
          <div class="w-[36px] h-[2px] bg-brand-orange"></div>
        </div>

        <h1 class="reveal-item font-display text-white leading-none" style="font-size: clamp(3rem, 7vw, 6rem); transition-delay: 120ms;">
          Accelerate Your Growth<br class="hidden sm:block"/> with Data-Driven Marketing
        </h1>

        <p class="reveal-item font-body text-gray-400 text-base md:text-lg max-w-2xl leading-relaxed" style="transition-delay: 180ms;">
          Accelerate your business growth with data-driven digital marketing strategies that increase brand visibility, generate qualified leads, and maximize return on investment. Our Digital &amp; Performance Marketing services combine targeted advertising, audience engagement, and advanced analytics to deliver measurable results across multiple channels.
        </p>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
      ...
      <div class="flex flex-col gap-8">
        ...
        <h2 class="reveal-item font-display text-white leading-none" style="font-size: clamp(2.8rem, 5.5vw, 4.5rem); transition-delay: 80ms;">
          Marketing That Delivers<br/>Measurable Results
        </h2>
        <p class="reveal-item font-body text-gray-400 text-base md:text-lg leading-relaxed" style="transition-delay: 140ms;">
          Whether you're looking to increase website traffic, boost conversions, or strengthen your brand presence, we create customized campaigns designed to reach the right audience at the right time.
        </p>
        <p class="reveal-item font-body text-gray-500 text-sm md:text-base leading-relaxed" style="transition-delay: 180ms;">
          We combine strategic planning, creative execution, and data-driven optimization to deliver marketing campaigns that generate real, measurable business outcomes.
        </p>
        ...
        <div class="relative border border-brand-border p-10 md:p-12 bg-brand-dark">
          ...
          <div class="flex flex-col gap-8">
            <div class="flex items-start gap-5 pb-7 border-b border-brand-border">
              ...
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">Targeted Advertising</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">Precision campaigns that reach your ideal audience across multiple digital platforms.</p>
              </div>
            </div>
            <div class="flex items-start gap-5 pb-7 border-b border-brand-border">
              <div class="w-8 h-px bg-brand-orange mt-3 flex-shrink-0"></div>
              <div>
                ...
                <p class="font-body text-gray-500 text-sm leading-relaxed">Meaningful connections with your audience through strategic content and targeted campaigns.</p>
              </div>
            </div>
            <div class="flex items-start gap-5">
              <div class="w-8 h-px bg-brand-orange mt-3 flex-shrink-0"></div>
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">ROI-Focused</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">Measurable outcomes driven by data-backed decisions and continuous optimization.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        <p class="reveal-item font-body text-gray-400 leading-relaxed text-base lg:text-lg" style="transition-delay: 140ms;">
          Data-driven marketing services designed to increase visibility, engage audiences, and maximize ROI.
        </p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">

        <!-- Card 1: Google Ads & PPC Campaigns -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-6" style="transition-delay: 0ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Google Ads &amp; PPC Campaigns</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Drive immediate traffic and high-intent leads with strategically managed pay-per-click advertising campaigns. We develop, optimize, and monitor campaigns to ensure maximum performance while keeping your advertising budget efficient.
            </p>
          </div>
          <div class="font-body text-brand-orange text-xs tracking-[0.2em] uppercase font-medium">Key Deliverables</div>
          <ul class="font-body text-gray-400 space-y-2.5">
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Google Search Ads</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Display Advertising Campaigns</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Google Shopping Ads</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>YouTube Advertising</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Keyword Research &amp; Bid Management</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Conversion Tracking &amp; Optimization</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Remarketing Campaigns</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Landing Page Recommendations</li>
          </ul>
        ...
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-6" style="transition-delay: 80ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Social Media Marketing</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Build meaningful connections with your audience through engaging social media strategies that increase brand awareness, customer engagement, and lead generation.
            </p>
          </div>
          <div class="font-body text-brand-orange text-xs tracking-[0.2em] uppercase font-medium">Key Deliverables</div>
          <ul class="font-body text-gray-400 space-y-2.5">
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Social Media Strategy Development</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Content Planning &amp; Scheduling</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Paid Social Advertising</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Community Management</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Audience Growth Campaigns</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Brand Awareness Initiatives</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Social Media Performance Analysis</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Influencer Collaboration Support</li>
          </ul>
          <div class="pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
          </div>
        ...
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-6" style="transition-delay: 160ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Performance Marketing</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Focus on measurable outcomes with performance-driven campaigns designed to generate leads, sales, and revenue. We continuously optimize campaigns using real-time data to improve efficiency and results.
            </p>
          </div>
          <div class="font-body text-brand-orange text-xs tracking-[0.2em] uppercase font-medium">Key Deliverables</div>
          <ul class="font-body text-gray-400 space-y-2.5">
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Lead Generation Campaigns</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Conversion Rate Optimization (CRO)</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Customer Acquisition Strategies</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Multi-Channel Campaign Management</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Retargeting &amp; Funnel Optimization</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>A/B Testing &amp; Experimentation</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Budget Allocation Optimization</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>ROI-Focused Campaign Scaling</li>
          </ul>
          <div class="pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
          </div>
        ...
        <!-- Card 4: Analytics & Campaign Reporting -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-6" style="transition-delay: 240ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Analytics &amp; Campaign Reporting</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Make informed business decisions with transparent reporting and actionable insights. We track campaign performance across all channels and provide detailed reports that highlight growth opportunities and marketing effectiveness.
            </p>
          </div>
          <div class="font-body text-brand-orange text-xs tracking-[0.2em] uppercase font-medium">Key Deliverables</div>
          <ul class="font-body text-gray-400 space-y-2.5">
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Google Analytics Setup &amp; Management</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Campaign Performance Tracking</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Custom Marketing Dashboards</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Conversion &amp; Attribution Analysis</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Audience Behavior Insights</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>KPI Monitoring &amp; Reporting</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Monthly Performance Reviews</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Strategic Recommendations</li>
          </ul>
          <div class="pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
          </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        <p class="reveal-item font-body text-gray-400 text-sm sm:text-base leading-relaxed max-w-2xl" style="transition-delay: 140ms;">
          Data-driven strategies focused on measurable results, powered by certified digital marketing specialists.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-0 w-full">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 0ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Data-Driven Strategies Focused on Measurable Results</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Every campaign is built on data insights and optimized for maximum return on investment.
            </p>
          </div>
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 80ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Certified Digital Marketing Specialists</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Our team brings certified expertise across search, social, and display advertising platforms.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 160ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Transparent Reporting &amp; Performance Tracking</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Regular detailed reports that show exactly how your campaigns are performing and what's driving results.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 240ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Customized Campaigns Tailored to Your Business Goals</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We develop marketing strategies that align with your unique objectives, target audience, and budget.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 320ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Multi-Channel Expertise Across Search, Social &amp; Display</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Integrated campaigns that reach your audience across multiple digital touchpoints for maximum impact.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 400ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Continuous Optimization for Maximum ROI</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We continuously refine campaigns using real-time data to ensure your marketing budget delivers the highest possible return on investment.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 480ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Scalable Solutions for Businesses of All Sizes</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Whether you're a startup or an enterprise, our marketing solutions scale to meet your needs and grow with your business.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <section class="relative bg-brand-dark overflow-hidden py-24 md:py-36 px-5 sm:px-8 md:px-16 lg:px-24 border-t border-brand-border">
    ...
    <div class="relative z-10 max-w-7xl mx-auto flex flex-col items-center text-center gap-16">
      ...
      <h2 class="reveal-item font-display text-white leading-tight max-w-5xl" style="font-size: clamp(2.4rem, 5.5vw, 4.5rem); transition-delay: 80ms;">
        We help businesses attract more customers, increase conversions, and achieve marketing goals through strategic, data-driven digital and performance marketing solutions.
      </h2>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6 w-full">
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 0ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Strategy</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Data-driven plans that align with your business goals and target audience.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 80ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Reach</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Multi-channel campaigns that connect with your audience wherever they are.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 160ms;">
          ...
          <p class="font-body text-gray-600 text-xs leading-relaxed">Audience connection through compelling content and targeted interactions.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 240ms;">
          ...
          <p class="font-body text-gray-600 text-xs leading-relaxed">Scalable results that drive long-term business success and revenue.</p>
        </div>
  ...
  <section class="relative bg-white overflow-hidden py-20 md:py-28 px-5 sm:px-8 md:px-16 lg:px-24 flex flex-col items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center justify-center text-center gap-7">
      ...
      <p class="reveal-item font-body text-gray-500 text-sm sm:text-base md:text-lg max-w-xl mt-1 mx-auto leading-relaxed" style="transition-delay: 160ms;">
        Partner with us to attract more customers, increase conversions, and achieve your marketing goals.
      </p>
      ...
      <div class="reveal-item flex flex-col sm:flex-row items-center justify-center gap-4 mt-6" style="transition-delay: 240ms;">
        ...
        <a href="{{ route('contact') }}"
          ...
          <span class="relative z-10 font-medium group-hover:text-white transition-colors duration-300">Start Your Marketing Journey</span>
  ...
  <section class="relative bg-brand-dark overflow-hidden py-24 md:py-32 px-8 md:px-16 lg:px-24 border-t border-brand-border">
    ...
    <div class="relative z-10 flex flex-col items-center text-center gap-6 max-w-7xl mx-auto mb-14 md:mb-16">
      ...
      <p class="reveal-item font-body text-gray-400 text-sm sm:text-base max-w-2xl leading-relaxed" style="transition-delay: 100ms;">
        Everything you need to know about digital and performance marketing.
      </p>
    </div>
    ...
    <div class="relative z-10 max-w-3xl mx-auto space-y-3 md:space-y-4">
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">What is performance marketing?</span>
        ...
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Performance marketing focuses on measurable results such as leads, conversions, sales, and return on advertising spend.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">Which advertising platforms do you manage?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              We manage campaigns on Google Ads, Facebook, Instagram, LinkedIn, YouTube, and other digital advertising platforms.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">Can you help generate leads for my business?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Yes. Our campaigns are designed to attract qualified leads and maximize conversion opportunities.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">How do you measure campaign performance?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              We track impressions, clicks, conversions, cost per lead, return on ad spend (ROAS), and overall campaign effectiveness.
            </div>
          </div>
        </div>
      </details>

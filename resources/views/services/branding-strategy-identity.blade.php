...
<head>
  ...
  <title>Branding, Strategy &amp; Identity - Simha Interactive</title>
...
<body>
  ...
  <section class="relative bg-brand-dark overflow-hidden pt-40 pb-20 md:pt-52 md:pb-36 px-5 sm:px-8 md:px-16 lg:px-24 min-h-[90vh] flex items-center">
    ...
    <div class="absolute right-0 md:right-8 top-1/2 -translate-y-1/2 font-display text-white pointer-events-none select-none hidden lg:block"
         style="font-size: clamp(16rem, 22vw, 28rem); opacity: 0.018; line-height: 1; letter-spacing: -0.05em;">B</div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto w-full">
      <div class="flex flex-col items-center text-center gap-7 max-w-4xl mx-auto">
        ...
        <div class="reveal-item flex items-center justify-center gap-3" style="transition-delay: 60ms;">
          ...
          <span class="font-body text-xs text-brand-orange tracking-[0.4em] uppercase font-medium">Branding &amp; Identity</span>
          <div class="w-[36px] h-[2px] bg-brand-orange"></div>
        </div>

        <!-- H1 -->
        <h1 class="reveal-item font-display text-white leading-none" style="font-size: clamp(3rem, 7vw, 6rem); transition-delay: 120ms;">
          Build a Brand That<br class="hidden sm:block"/> Inspires Trust
        </h1>

        <!-- Supporting text -->
        <p class="reveal-item font-body text-gray-400 text-base md:text-lg max-w-2xl leading-relaxed" style="transition-delay: 180ms;">
          Your brand is more than a logo—it's how customers perceive and remember your business. At Simha Interactive, we create strategic brand identities that help businesses stand out, build credibility, and connect with their target audience.
        </p>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
      ...
      <div class="flex flex-col gap-8">
        ...
        <h2 class="reveal-item font-display text-white leading-none" style="font-size: clamp(2.8rem, 5.5vw, 4.5rem); transition-delay: 80ms;">
          Strategic Branding<br/>That Drives Growth
        </h2>
        <p class="reveal-item font-body text-gray-400 text-base md:text-lg leading-relaxed" style="transition-delay: 140ms;">
          Our branding solutions combine strategy, creativity, and consistency to ensure your brand communicates the right message across every touchpoint.
        </p>
        <p class="reveal-item font-body text-gray-500 text-sm md:text-base leading-relaxed" style="transition-delay: 180ms;">
          We go beyond aesthetics — we build strategic brand systems rooted in market research, audience insights, and competitive positioning. Every element we create is purposeful, cohesive, and built to last.
        </p>
        ...
        <div class="relative border border-brand-border p-10 md:p-12 bg-brand-dark">
          ...
          <div class="flex flex-col gap-8">
            ...
            <div class="flex items-start gap-5 pb-7 border-b border-brand-border">
              ...
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">Strategy First</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">Every design decision is grounded in market research, audience psychology, and competitive positioning.</p>
              </div>
            </div>
            <!-- Pillar 2 -->
            <div class="flex items-start gap-5 pb-7 border-b border-brand-border">
              <div class="w-8 h-px bg-brand-orange mt-3 flex-shrink-0"></div>
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">Creative Precision</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">Distinctive visual systems crafted with meticulous attention to detail and timeless design principles.</p>
              </div>
            </div>
            <!-- Pillar 3 -->
            <div class="flex items-start gap-5">
              <div class="w-8 h-px bg-brand-orange mt-3 flex-shrink-0"></div>
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">Brand Consistency</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">Cohesive identity systems that communicate your brand with clarity and confidence across every channel.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        <p class="reveal-item font-body text-gray-400 leading-relaxed text-base lg:text-lg" style="transition-delay: 140ms;">
          A complete suite of branding services designed to build powerful, consistent, and memorable brand identities.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
        ...
        <!-- Card 1: Brand Strategy Development -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 0ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Brand Strategy Development</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              We define your brand vision, mission, values, and market positioning to create a strong foundation for sustainable growth.
            </p>
          </div>
        ...
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 80ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Brand Positioning</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Differentiate your business with a clear positioning strategy that highlights your unique value proposition and competitive advantage.
            </p>
          </div>
          <div class="mt-auto pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
        ...
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 160ms;">
          <div class="service-icon w-10 h-10">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="w-10 h-10">
              <path d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125"/>
            </svg>
          </div>
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Logo Design</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Create a memorable and professional logo that reflects your brand personality and leaves a lasting impression on your audience.
            </p>
          </div>
          <div class="mt-auto pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
        ...
        <!-- Card 4: Visual Identity Systems -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 240ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Visual Identity Systems</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Develop cohesive visual elements—colors, typography, graphics, and imagery—for a consistent and recognizable brand presence.
            </p>
          </div>
          <div class="mt-auto pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
        ...
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 320ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Brand Guidelines</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Ensure brand consistency with comprehensive guidelines covering logo usage, color systems, typography, and communication standards.
            </p>
          </div>
          <div class="mt-auto pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
        ...
        <!-- Card 6: Corporate Identity Design -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 400ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Corporate Identity Design</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Strengthen your professional image with branded business cards, letterheads, presentations, email signatures, and corporate materials.
            </p>
          </div>
          <div class="mt-auto pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
  ...
  <section class="relative bg-brand-dark overflow-hidden py-24 md:py-36 px-5 sm:px-8 md:px-16 lg:px-24 border-t border-brand-border">
    <div class="max-w-7xl mx-auto flex flex-col gap-14">
      ...
      <div class="flex flex-col items-center text-center gap-5">
        <div class="reveal-item flex items-center justify-center gap-3">
          <div class="w-[36px] h-[2px] bg-brand-orange"></div>
          <span class="font-body text-xs text-brand-orange tracking-[0.4em] uppercase font-medium">Creative Portfolio</span>
          <div class="w-[36px] h-[2px] bg-brand-orange"></div>
        </div>
        <h2 class="reveal-item font-display text-white leading-none" style="font-size: clamp(3rem, 7vw, 5.5rem); transition-delay: 80ms;">
          Crafted Identities
        ...
        <p class="reveal-item font-body text-gray-400 text-base leading-relaxed max-w-2xl" style="transition-delay: 140ms;">
          A visual testament to the brands we’ve helped define, differentiate, and bring to life across industries.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <!-- Slot 1: Logo Design Carousel (6 images) -->
        <div class="reveal-item showcase-item relative overflow-hidden showcase-feature md:col-span-2 lg:col-span-2 group" style="transition-delay: 0ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><img src="{{ asset('assets/service-images/Branding/Logo Design/AIREM.jpg') }}" alt="Logo Design" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Logo Design/Command Collective_logo_page-0001.jpg') }}" alt="Logo Design" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Logo Design/Command Collective_logo_page-0003.jpg') }}" alt="Logo Design" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Logo Design/Command Collective_logo_page-0005.jpg') }}" alt="Logo Design" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Logo Design/Command Collective_logo_page-0007.jpg') }}" alt="Logo Design" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Logo Design/Command Collective_logo_page-0009.jpg') }}" alt="Logo Design" class="w-full h-full object-cover" loading="lazy"></div>
          ...
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">Logo Design</p></div>
          <div class="service-img-line"></div>
        </div>

        <!-- Slot 2: Visual Identity Systems Carousel (7 images) -->
        <div class="reveal-item showcase-item relative overflow-hidden group" style="aspect-ratio: 8/9; transition-delay: 80ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><img src="{{ asset('assets/service-images/Branding/Visual Identity Systems/Command Collective_logo_page-0002.jpg') }}" alt="Visual Identity" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Visual Identity Systems/Command Collective_logo_page-0004.jpg') }}" alt="Visual Identity" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Visual Identity Systems/Command Collective_logo_page-0006.jpg') }}" alt="Visual Identity" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Visual Identity Systems/Command Collective_logo_page-0008.jpg') }}" alt="Visual Identity" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Visual Identity Systems/Command Collective_logo_page-0010.jpg') }}" alt="Visual Identity" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Visual Identity Systems/AIREM Living brand guideline_page-0006.jpg') }}" alt="Visual Identity" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Visual Identity Systems/AIREM Living brand guideline_page-0008.jpg') }}" alt="Visual Identity" class="w-full h-full object-cover" loading="lazy"></div>
            <button class="carousel-arrow carousel-arrow-prev" aria-label="Previous">‹</button>
            <button class="carousel-arrow carousel-arrow-next" aria-label="Next">›</button>
          </div>
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">Visual Identity Systems</p></div>
          <div class="service-img-line"></div>
        </div>

        <!-- Slot 3: Brand Guidelines Carousel (14 images) -->
        <div class="reveal-item showcase-item relative overflow-hidden showcase-cinema md:col-span-2 lg:col-span-3 group" style="transition-delay: 160ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/Command Collective_Brand Guideline_New_page-0002.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/Command Collective_Brand Guideline_New_page-0003.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/Command Collective_Brand Guideline_New_page-0004.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/Command Collective_Brand Guideline_New_page-0005.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/Command Collective_Brand Guideline_New_page-0006.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/Command Collective_Brand Guideline_New_page-0007.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/Command Collective_Brand Guideline_New_page-0008.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/AIREM Living brand guideline_page-0004.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/AIREM Living brand guideline_page-0007.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/AIREM Living brand guideline_page-0010.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/AIREM Living brand guideline_page-0011.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/AIREM Living brand guideline_page-0012.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/AIREM Living brand guideline_page-0014.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/AIREM Living brand guideline_page-0015.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Branding/Brand Guidelines/AIREM Living brand guideline_page-0017.jpg') }}" alt="Brand Guidelines" class="w-full h-full object-cover" loading="lazy"></div>
            <button class="carousel-arrow carousel-arrow-prev" aria-label="Previous">‹</button>
            <button class="carousel-arrow carousel-arrow-next" aria-label="Next">›</button>
          </div>
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">Brand Guidelines</p></div>
          <div class="service-img-line"></div>
        </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        <p class="reveal-item font-body text-gray-400 text-sm sm:text-base leading-relaxed max-w-2xl" style="transition-delay: 140ms;">
          We don't just design logos — we build strategic brand systems that connect with people, command respect, and grow with your business.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-0 w-full">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 0ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Strategic &amp; Research-Driven Approach</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Every branding decision we make is backed by in-depth market research, audience insights, and competitive analysis.
            </p>
          </div>
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 80ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Creative &amp; Impactful Design Solutions</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We craft bold, distinctive brand identities that cut through the noise and make a powerful, lasting impression.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 160ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Consistent Brand Development Process</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Our structured process ensures every brand element aligns perfectly—from initial strategy through to final delivery.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 240ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Industry-Focused Expertise</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              15+ years across real estate, hospitality, retail, and corporate sectors — we understand what moves your specific audience.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 320ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">End-to-End Branding Support</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              From brand discovery and strategy through design, guidelines, and corporate materials — we manage the entire branding journey.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <section class="relative bg-brand-dark overflow-hidden py-24 md:py-36 px-5 sm:px-8 md:px-16 lg:px-24 border-t border-brand-border">
    ...
    <div class="relative z-10 max-w-7xl mx-auto flex flex-col items-center text-center gap-16">
      ...
      <h2 class="reveal-item font-display text-white leading-tight max-w-5xl" style="font-size: clamp(2.4rem, 5.5vw, 4.5rem); transition-delay: 80ms;">
        We help businesses create strong, recognizable brands that build trust, enhance visibility, and drive long-term success.
      </h2>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6 w-full">
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 0ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Credibility</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Build authority and trust with a professional, polished brand identity.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 80ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Growth</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Strategic branding that fuels business growth and market expansion.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 160ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Trust</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">A consistent brand experience that deepens customer loyalty and retention.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 240ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Recognition</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Create a distinct visual language that gets instantly recognized and remembered.</p>
        </div>
  ...
  <section class="relative bg-white overflow-hidden py-20 md:py-28 px-5 sm:px-8 md:px-16 lg:px-24 flex flex-col items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center justify-center text-center gap-7">
      ...
      <p class="reveal-item font-body text-gray-500 text-sm sm:text-base md:text-lg max-w-xl mt-1 mx-auto leading-relaxed" style="transition-delay: 160ms;">
        Let's create an identity that truly represents your business and resonates with your audience.
      </p>
      ...
      <div class="reveal-item flex flex-col sm:flex-row items-center justify-center gap-4 mt-6" style="transition-delay: 240ms;">
        ...
        <a href="{{ route('contact') }}"
          ...
          <span class="relative z-10 font-medium group-hover:text-white transition-colors duration-300">Schedule a Consultation</span>
  ...
  <section class="relative bg-brand-dark overflow-hidden py-24 md:py-32 px-8 md:px-16 lg:px-24 border-t border-brand-border">
    ...
    <div class="relative z-10 flex flex-col items-center text-center gap-6 max-w-7xl mx-auto mb-14 md:mb-16">
      ...
      <p class="reveal-item font-body text-gray-400 text-sm sm:text-base max-w-2xl leading-relaxed" style="transition-delay: 100ms;">
        Everything you need to know about branding, strategy, and identity.
      </p>
    </div>
    ...
    <div class="relative z-10 max-w-3xl mx-auto space-y-3 md:space-y-4">
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">What is branding, and why is it important?</span>
        ...
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Branding creates a unique identity for your business through visual elements, messaging, and customer experience. It helps build recognition, trust, and long-term customer loyalty.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">What branding services do you provide?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              We offer brand strategy, logo design, visual identity development, brand guidelines, brand positioning, messaging frameworks, and marketing collateral design.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">Can you help with rebranding an existing business?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Yes. We help businesses refresh and modernize their brand identity while maintaining consistency and market relevance.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">Will I receive brand guidelines after the project?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Yes. We provide comprehensive brand guidelines covering logo usage, typography, color palettes, imagery, and communication standards.
            </div>
          </div>
        </div>
      </details>

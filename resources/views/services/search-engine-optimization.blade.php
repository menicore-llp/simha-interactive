...
<head>
  ...
  <title>Search Engine Optimization (SEO) - Simha Interactive</title>
...
<body>
  ...
  <section class="relative bg-brand-dark overflow-hidden pt-40 pb-20 md:pt-52 md:pb-36 px-5 sm:px-8 md:px-16 lg:px-24 min-h-[90vh] flex items-center">
    ...
    <div class="absolute right-0 md:right-8 top-1/2 -translate-y-1/2 font-display text-white pointer-events-none select-none hidden lg:block"
         style="font-size: clamp(16rem, 22vw, 28rem); opacity: 0.018; line-height: 1; letter-spacing: -0.05em;">S</div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto w-full">
      <div class="flex flex-col items-center text-center gap-7 max-w-4xl mx-auto">
        ...
        <div class="reveal-item flex items-center justify-center gap-3" style="transition-delay: 60ms;">
          ...
          <span class="font-body text-xs text-brand-orange tracking-[0.4em] uppercase font-medium">Search Engine Optimization</span>
          <div class="w-[36px] h-[2px] bg-brand-orange"></div>
        </div>

        <h1 class="reveal-item font-display text-white leading-none" style="font-size: clamp(3rem, 7vw, 6rem); transition-delay: 120ms;">
          Increase Your Online<br class="hidden sm:block"/> Visibility & Drive Organic Traffic
        </h1>

        <p class="reveal-item font-body text-gray-400 text-base md:text-lg max-w-2xl leading-relaxed" style="transition-delay: 180ms;">
          Increase your online visibility, attract qualified traffic, and improve your search engine rankings with data-driven SEO strategies. Our SEO services are designed to help businesses establish a strong digital presence, generate more leads, and achieve sustainable long-term growth through organic search.
        </p>
        ...
        <div class="reveal-item mt-2" style="transition-delay: 240ms;">
          <a href="{{ route('contact') }}"
            ...
            <span>Let's Boost Your Rankings</span>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
      ...
      <div class="flex flex-col gap-8">
        ...
        <h2 class="reveal-item font-display text-white leading-none" style="font-size: clamp(2.8rem, 5.5vw, 4.5rem); transition-delay: 80ms;">
          Data-Driven SEO<br/>Strategies for Success
        </h2>
        <p class="reveal-item font-body text-gray-400 text-base md:text-lg leading-relaxed" style="transition-delay: 140ms;">
          Whether you're looking to improve local visibility, outrank competitors, or enhance your website's technical performance, our team develops customized SEO solutions aligned with your business goals and target audience.
        </p>
        <p class="reveal-item font-body text-gray-500 text-sm md:text-base leading-relaxed" style="transition-delay: 180ms;">
          We combine technical expertise, strategic content creation, and ethical link-building practices to deliver measurable improvements in search rankings and organic traffic.
        </p>
        ...
        <div class="relative border border-brand-border p-10 md:p-12 bg-brand-dark">
          ...
          <div class="flex flex-col gap-8">
            <div class="flex items-start gap-5 pb-7 border-b border-brand-border">
              ...
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">On-Page &amp; Off-Page SEO</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">Comprehensive optimization and ethical link-building to improve rankings and authority.</p>
              </div>
            </div>
            <div class="flex items-start gap-5 pb-7 border-b border-brand-border">
              <div class="w-8 h-px bg-brand-orange mt-3 flex-shrink-0"></div>
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">Technical SEO Audits</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">In-depth analysis of crawlability, site performance, and indexing health.</p>
              </div>
            </div>
            <div class="flex items-start gap-5">
              <div class="w-8 h-px bg-brand-orange mt-3 flex-shrink-0"></div>
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">Keyword Strategy &amp; Research</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">Data-driven keyword targeting to attract high-value traffic and conversions.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        <p class="reveal-item font-body text-gray-400 leading-relaxed text-base lg:text-lg" style="transition-delay: 140ms;">
          Comprehensive SEO solutions designed to improve your search visibility and drive sustainable organic growth.
        </p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">

        <!-- Card 1: On-Page & Off-Page SEO -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-6" style="transition-delay: 0ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">On-Page &amp; Off-Page SEO</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              We optimize every aspect of your website to improve search engine rankings and user experience. From content optimization and metadata enhancements to strategic link-building campaigns, we ensure your website meets search engine best practices while building authority across the web.
            </p>
          </div>
          ...
          <ul class="font-body text-gray-400 space-y-2.5">
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Title tag and meta description optimization</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Content optimization and internal linking</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>URL structure improvements</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Quality backlink acquisition</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Local SEO optimization</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Competitor analysis</li>
          </ul>
        ...
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-6" style="transition-delay: 80ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Technical SEO Audits</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              A technically sound website is essential for search engine success. We conduct comprehensive audits to identify and resolve issues that may be affecting your website's performance, crawlability, and indexing.
            </p>
          </div>
          <div class="font-body text-brand-orange text-xs tracking-[0.2em] uppercase font-medium mb-4">Key Deliverables</div>
          <ul class="font-body text-gray-400 space-y-2.5">
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Website health assessment</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Site speed optimization recommendations</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Mobile usability analysis</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Crawl error detection and resolution</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Structured data implementation</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>XML sitemap and robots.txt optimization</li>
          </ul>
          <div class="pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
          </div>
        ...
        <!-- Card 3: Keyword Strategy & Research -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-6" style="transition-delay: 160ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Keyword Strategy &amp; Research</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              We identify high-value keywords that align with your products, services, and customer search intent. Our research-driven approach ensures your business targets terms that generate relevant traffic and conversions.
            </p>
          </div>
          <div class="font-body text-brand-orange text-xs tracking-[0.2em] uppercase font-medium mb-4">Key Deliverables</div>
          <ul class="font-body text-gray-400 space-y-2.5">
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Industry and competitor keyword analysis</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Search intent mapping</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Long-tail keyword opportunities</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Content gap analysis</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Keyword prioritization strategy</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Ongoing keyword performance tracking</li>
          </ul>
          <div class="pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
          </div>
        ...
        <!-- Card 4: Content Marketing & Optimization -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-6" style="transition-delay: 240ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Content Marketing &amp; Optimization</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Quality content plays a critical role in SEO success. We create and optimize engaging, search-friendly content that attracts visitors, builds authority, and drives conversions.
            </p>
          </div>
          <div class="font-body text-brand-orange text-xs tracking-[0.2em] uppercase font-medium mb-4">Key Deliverables</div>
          <ul class="font-body text-gray-400 space-y-2.5">
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>SEO content strategy</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Blog and article optimization</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Landing page content enhancement</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Content gap identification</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Content performance analysis</li>
            <li class="flex items-start gap-3"><span class="text-brand-orange mt-1 flex-shrink-0">•</span>Conversion-focused copy improvements</li>
          </ul>
          <div class="pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
          </div>
      ...
      <div class="reveal-item mt-4 w-full flex justify-center" style="transition-delay: 200ms;">
        <a href="{{ route('contact') }}" class="btn-ghost border border-white text-white px-8 py-3.5 font-body text-sm tracking-widest uppercase inline-flex">
          <span>Discuss Your SEO Strategy</span>
        </a>
      </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        <p class="reveal-item font-body text-gray-400 text-sm sm:text-base leading-relaxed max-w-2xl" style="transition-delay: 140ms;">
          Customized strategies tailored to your industry and goals, powered by ethical white-hat SEO practices.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-0 w-full">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 0ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Customized Strategies Tailored to Your Industry &amp; Goals</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We develop SEO strategies that align with your unique business objectives, target audience, and competitive landscape.
            </p>
          </div>
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 80ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Ethical, White-Hat SEO Practices</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We follow search engine guidelines to build sustainable rankings without risk of penalties.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 160ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            ...
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Regular detailed reports that show exactly how your SEO campaigns are performing and what's driving results.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 240ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Focus on Long-Term Organic Growth</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We build sustainable SEO foundations that continue delivering results and adapt to algorithm changes.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 320ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Continuous Optimization Based on Data &amp; Results</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We constantly analyze performance data to refine strategies and maximize your return on investment.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 400ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Dedicated SEO Specialists Committed to Your Success</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Work with a dedicated team of SEO experts who are invested in helping your business achieve and maintain top search rankings.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <section class="relative bg-brand-dark overflow-hidden py-24 md:py-36 px-5 sm:px-8 md:px-16 lg:px-24 border-t border-brand-border">
    ...
    <div class="relative z-10 max-w-7xl mx-auto flex flex-col items-center text-center gap-16">
      ...
      <h2 class="reveal-item font-display text-white leading-tight max-w-5xl" style="font-size: clamp(2.4rem, 5.5vw, 4.5rem); transition-delay: 80ms;">
        We help businesses improve search visibility, attract qualified leads, and achieve measurable growth through ethical, data-driven SEO strategies.
      </h2>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6 w-full">
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 0ms;">
          ...
          <p class="font-body text-gray-600 text-xs leading-relaxed">Customized SEO plans tailored to your business goals.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 80ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Transparency</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Clear reporting and open communication on performance.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 160ms;">
          ...
          <p class="font-body text-gray-600 text-xs leading-relaxed">Sustainable results that scale with your business.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 240ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Authority</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Build thought leadership and industry credibility.</p>
        </div>
  ...
  <section class="relative bg-white overflow-hidden py-20 md:py-28 px-5 sm:px-8 md:px-16 lg:px-24 flex flex-col items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center justify-center text-center gap-7">
      ...
      <h2 class="reveal-item font-display text-brand-dark leading-none" style="font-size: clamp(3rem, 7vw, 5.5rem); transition-delay: 80ms;">
        Ready to Grow Your<br/>Organic Traffic?
      </h2>
      ...
      <p class="reveal-item font-body text-gray-500 text-sm sm:text-base md:text-lg max-w-xl mt-1 mx-auto leading-relaxed" style="transition-delay: 160ms;">
        Partner with us to improve your search visibility, attract more qualified leads, and achieve measurable business growth.
      </p>
      ...
      <div class="reveal-item flex flex-col sm:flex-row items-center justify-center gap-4 mt-6" style="transition-delay: 240ms;">
        ...
        <a href="{{ route('contact') }}"
          ...
          <span class="relative z-10 font-medium group-hover:text-white transition-colors duration-300">Start Your SEO Journey</span>
    ...
    <div class="relative z-10 max-w-3xl mx-auto space-y-3 md:space-y-4">
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">What is SEO?</span>
        ...
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              SEO helps improve your website&rsquo;s visibility on search engines like Google, increasing organic traffic and potential leads.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">What SEO services do you offer?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              We provide keyword research, technical SEO, on-page optimization, local SEO, content optimization, link-building strategies, and SEO audits.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">How long does SEO take to show results?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Most businesses begin seeing measurable improvements within 3&ndash;6 months.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">Do you provide SEO performance reports?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Yes. We provide regular reports that track rankings, traffic, website performance, and optimization progress.
            </div>
          </div>
        </div>
      </details>

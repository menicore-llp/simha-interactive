...
<head>
  ...
  <title>Architectural Visualization - Simha Interactive</title>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      // Carousels with auto-rotate + manual arrows
    ...
    <div class="relative z-10 max-w-7xl mx-auto w-full">
      <div class="flex flex-col items-center text-center gap-7 max-w-4xl mx-auto">
        ...
        <div class="reveal-item flex items-center justify-center gap-3" style="transition-delay: 60ms;">
          ...
          <span class="font-body text-xs text-brand-orange tracking-[0.4em] uppercase font-medium">Architectural Visualization</span>
          <div class="w-[36px] h-[2px] bg-brand-orange"></div>
        </div>

        <h1 class="reveal-item font-display text-white leading-none" style="font-size: clamp(3rem, 7vw, 6rem); transition-delay: 120ms;">
          Transform Concepts into<br class="hidden sm:block"/> Compelling Visual Experiences
        </h1>

        <p class="reveal-item font-body text-gray-400 text-base md:text-lg max-w-2xl leading-relaxed" style="transition-delay: 180ms;">
          Architectural visualization helps bring designs to life before construction begins. At Simha Interactive, we create high-quality, photorealistic visuals that enable architects, developers, builders, and real estate professionals to present their projects with clarity and impact.
        </p>
        ...
        <div class="reveal-item mt-2" style="transition-delay: 240ms;">
          <a href="{{ route('contact') }}"
            ...
            <span>Let's Visualize Your Project</span>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
      ...
      <div class="flex flex-col gap-8">
        ...
        <h2 class="reveal-item font-display text-white leading-none" style="font-size: clamp(2.8rem, 5.5vw, 4.5rem); transition-delay: 80ms;">
          Bringing Designs to<br/>Life with Precision
        </h2>
        <p class="reveal-item font-body text-gray-400 text-base md:text-lg leading-relaxed" style="transition-delay: 140ms;">
          Our visualization solutions help stakeholders understand design concepts, support decision-making, and enhance marketing efforts through immersive and engaging presentations.
        </p>
        <p class="reveal-item font-body text-gray-500 text-sm md:text-base leading-relaxed" style="transition-delay: 180ms;">
          We combine cutting-edge rendering technology with artistic expertise to produce visuals that accurately reflect design intent while evoking emotion and building confidence in your project.
        </p>
          ...
          <div class="flex flex-col gap-8">
            <div class="flex items-start gap-5 pb-7 border-b border-brand-border">
              ...
              <div>
                ...
                <p class="font-body text-gray-500 text-sm leading-relaxed">Every detail meticulously rendered to produce images that are virtually indistinguishable from photographs.</p>
              </div>
            </div>
            <div class="flex items-start gap-5 pb-7 border-b border-brand-border">
              <div class="w-8 h-px bg-brand-orange mt-3 flex-shrink-0"></div>
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">Immersive Experiences</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">Walkthrough animations and 3D tours that give stakeholders a realistic sense of space and flow.</p>
              </div>
            </div>
            <div class="flex items-start gap-5">
              <div class="w-8 h-px bg-brand-orange mt-3 flex-shrink-0"></div>
              <div>
                <h4 class="font-body font-medium text-white text-sm tracking-wider uppercase mb-2">Marketing Ready</h4>
                <p class="font-body text-gray-500 text-sm leading-relaxed">High-quality visuals optimized for presentations, approvals, brochures, and digital marketing campaigns.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        <p class="reveal-item font-body text-gray-400 leading-relaxed text-base lg:text-lg" style="transition-delay: 140ms;">
          Comprehensive architectural visualization services designed to present your projects with clarity and impact.
        </p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">

        <!-- Card 1: Interior Rendering -->
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 0ms;">
          <div class="service-icon w-10 h-10">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="w-10 h-10">
              <path d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25z"/>
            </svg>
          </div>
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Interior Rendering</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Showcase interior spaces with realistic lighting, materials, textures, and furnishings that accurately reflect the design vision.
            </p>
          </div>
        ...
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 80ms;">
          <div class="service-icon w-10 h-10">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="w-10 h-10">
              <path d="M2.25 15a4.5 4.5 0 004.5-4.5V18l-3-2.25M3.75 6.75h.008v.008H3.75V6.75zM12 2.25l-5.25 5.25m0 0L12 2.25m-5.25 5.25L12 12m0 0l3-3m-3 3l4.5 4.5M16.5 9.75h.008v.008H16.5V9.75z"/>
            </svg>
          </div>
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Exterior Rendering</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Create stunning exterior visualizations that highlight architectural details, landscaping, surroundings, and overall project aesthetics.
            </p>
          </div>
          <div class="mt-auto pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
        ...
        <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5" style="transition-delay: 160ms;">
          ...
          <div>
            <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">3D Floor Plans</h3>
            <p class="font-body text-gray-500 text-sm leading-relaxed">
              Present property layouts in an easy-to-understand visual format, helping buyers and stakeholders better visualize space utilization.
            </p>
          </div>
          <div class="mt-auto pt-5 border-t border-brand-border">
            <div class="w-8 h-[2px] bg-brand-orange"></div>
      ...
      <div class="flex flex-wrap justify-center gap-6 w-full">
        <div class="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)]">
          <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5 h-full" style="transition-delay: 240ms;">
            ...
            <div>
              <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Walkthrough Animations</h3>
              <p class="font-body text-gray-500 text-sm leading-relaxed">
                Deliver immersive virtual tours that guide viewers through a project, providing a realistic understanding of the design and flow.
              </p>
            </div>
            <div class="mt-auto pt-5 border-t border-brand-border">
              <div class="w-8 h-[2px] bg-brand-orange"></div>
        ...
        <div class="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)]">
          <div class="service-card reveal-item bg-brand-card p-7 md:p-9 border border-brand-border flex flex-col gap-5 h-full" style="transition-delay: 320ms;">
            ...
            <div>
              <h3 class="font-body text-white text-lg font-medium tracking-wide uppercase mb-3">Real Estate Marketing Visuals</h3>
              <p class="font-body text-gray-500 text-sm leading-relaxed">
                High-quality marketing images and presentation materials designed to attract buyers, investors, and potential tenants.
              </p>
            </div>
            <div class="mt-auto pt-5 border-t border-brand-border">
              <div class="w-8 h-[2px] bg-brand-orange"></div>
      ...
      <div class="reveal-item mt-4 w-full flex justify-center" style="transition-delay: 200ms;">
        <a href="{{ route('contact') }}" class="btn-ghost border border-white text-white px-8 py-3.5 font-body text-sm tracking-widest uppercase inline-flex">
          <span>Discuss Your Visualization Needs</span>
        </a>
      </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-14">
      ...
      <div class="flex flex-col items-center text-center gap-5">
        ...
        <p class="reveal-item font-body text-gray-400 text-base leading-relaxed max-w-2xl" style="transition-delay: 140ms;">
          A collection of projects brought to life through photorealistic visualization and immersive experiences.
        </p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">

        <!-- Interior Rendering Carousel (10 images) -->
        <div class="reveal-item showcase-item relative overflow-hidden showcase-feature md:col-span-2 lg:col-span-2 group" style="transition-delay: 0ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/1726551890035.jpg') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/1726551891405.jpg') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/5e16a4d9-f15a-49f9-b389-831c39bc81dc.jpg') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/75215733-fa9a-428e-9fd6-422ea9af5d1b.jpg') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/8a913d1e-3952-4c9a-bebe-caf37326ba9d.jpg') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/Cam_01_new.png') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/Cam_02_New.png') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/image.png') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/J000853_MS03_Highforest_S09_AptC624_Kitchen_Upgrade_Winter_Final-scaled.jpg') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Interior Render/J000853_MS03_Highforest_S22_HL11.06_Kitchen_Vignette_Final.jpg') }}" alt="Interior" class="w-full h-full object-cover" loading="lazy"></div>
          ...
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">Interior Rendering</p></div>
          <div class="service-img-line"></div>
        </div>

        <!-- Exterior Rendering Carousel (7 images) -->
        <div class="reveal-item showcase-item relative overflow-hidden group" style="aspect-ratio: 8/9; transition-delay: 80ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Superman_01.jpg') }}" alt="Exterior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Superman_02.png') }}" alt="Exterior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Superman_03.png') }}" alt="Exterior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Superman_04.jpg') }}" alt="Exterior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Superman_05.jpg') }}" alt="Exterior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Superman_06.png') }}" alt="Exterior" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Superman_07.png') }}" alt="Exterior" class="w-full h-full object-cover" loading="lazy"></div>

            <button class="carousel-arrow carousel-arrow-prev" aria-label="Previous">‹</button>
            <button class="carousel-arrow carousel-arrow-next" aria-label="Next">›</button>
          </div>
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">Exterior Rendering</p></div>
          <div class="service-img-line"></div>
        </div>

        <!-- 3D Floor Plans Carousel (10 images) -->
        <div class="reveal-item showcase-item relative overflow-hidden group" style="aspect-ratio: 4/3; transition-delay: 160ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/Fortune_A-&-B-Isomatric_00.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/Fortune_C-&-D-Isomatric_00.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/ISO_01.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/ISO_02.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/ISO_03.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/ISO_04.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/ISO_05.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/Isomatric Final HD View 1.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/Isomatric Final View 2.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/3D Floor Plans/ISOMATRIC VIEW_01.jpg.jpeg') }}" alt="3D Floor Plan" class="w-full h-full object-cover" loading="lazy"></div>

            <button class="carousel-arrow carousel-arrow-prev" aria-label="Previous">‹</button>
            <button class="carousel-arrow carousel-arrow-next" aria-label="Next">›</button>
          </div>
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">3D Floor Plans</p></div>
          <div class="service-img-line"></div>
        </div>

        <!-- Walkthrough Animations Carousel (3 videos) -->
        <div class="reveal-item showcase-item relative overflow-hidden group" style="aspect-ratio: 4/3; transition-delay: 240ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><video src="{{ asset('assets/service-images/Architectural Visualization/Walkthrough Animation/Navya Drawingroom_WL_Low.mp4') }}" muted loop playsinline preload="metadata" class="w-full h-full object-cover"></video></div>
            <div class="carousel-slide"><video src="{{ asset('assets/service-images/Architectural Visualization/Walkthrough Animation/Rajshree.mp4') }}" muted loop playsinline preload="metadata" class="w-full h-full object-cover"></video></div>
            <div class="carousel-slide"><video src="{{ asset('assets/service-images/Architectural Visualization/Walkthrough Animation/WhatsApp Video 2026-02-10 at 9.54.01 AM.mp4') }}" muted loop playsinline preload="metadata" class="w-full h-full object-cover"></video></div>

            <button class="carousel-arrow carousel-arrow-prev" aria-label="Previous">‹</button>
            <button class="carousel-arrow carousel-arrow-next" aria-label="Next">›</button>
          </div>
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">Walkthrough Animations</p></div>
          <div class="service-img-line"></div>
        </div>

        <!-- Real Estate Marketing Visuals Carousel (2 images) -->
        <div class="reveal-item showcase-item relative overflow-hidden group" style="aspect-ratio: 4/3; transition-delay: 320ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><img src="{{ asset('assets/service-images/Architectural Visualization/Real Estate Marketing Visuals/parq-1.jpg.jpeg') }}" alt="Real Estate" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Real Estate Marketing Visuals/parq-2.jpg.jpeg') }}" alt="Real Estate" class="w-full h-full object-cover" loading="lazy"></div>

            <button class="carousel-arrow carousel-arrow-prev" aria-label="Previous">‹</button>
            <button class="carousel-arrow carousel-arrow-next" aria-label="Next">›</button>
          </div>
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">Real Estate Marketing Visuals</p></div>
          <div class="service-img-line"></div>
        </div>

        <!-- Complete Project Visualization Carousel (6 images) -->
        <div class="reveal-item showcase-item relative overflow-hidden showcase-cinema md:col-span-2 lg:col-span-3 group" style="transition-delay: 400ms;">
          <div class="carousel-container">
            ...
            <div class="carousel-slide active"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Harmony Appartment_01.jpg') }}" alt="Project" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Harmony Appartment_02.jpg') }}" alt="Project" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Harmony Appartment_03.jpg') }}" alt="Project" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Harmony Appartment_04.jpg') }}" alt="Project" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Kings Lane_01.jpg') }}" alt="Project" class="w-full h-full object-cover" loading="lazy"></div>
            <div class="carousel-slide"><img src="{{ asset('assets/service-images/Architectural Visualization/Exterior Render/Kings Lane_02.jpg') }}" alt="Project" class="w-full h-full object-cover" loading="lazy"></div>

            <button class="carousel-arrow carousel-arrow-prev" aria-label="Previous">‹</button>
            <button class="carousel-arrow carousel-arrow-next" aria-label="Next">›</button>
          </div>
          <div class="showcase-label"><p class="font-body text-white text-xs tracking-[0.25em] uppercase font-medium">Complete Project Visualization</p></div>
          <div class="service-img-line"></div>
        </div>
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center">
      ...
      <div class="flex flex-col items-center text-center gap-6 max-w-3xl">
        ...
        <p class="reveal-item font-body text-gray-400 text-sm sm:text-base leading-relaxed max-w-2xl" style="transition-delay: 140ms;">
          We help transform architectural ideas into captivating visual stories that inspire confidence and drive project success.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-0 w-full">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 0ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Photorealistic Quality &amp; Attention to Detail</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Every pixel is crafted with precision to deliver visuals that rival real photography and exceed client expectations.
            </p>
          </div>
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 80ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Fast Turnaround Times</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We respect your deadlines and deliver high-quality visuals within agreed timelines without compromising on quality.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 160ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Experienced Architectural Visualization Team</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              Our team brings years of experience across residential, commercial, and mixed-use development projects.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 240ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Customized Solutions for Every Project</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              We tailor our approach to match each project's unique requirements, style, and target audience.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 320ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Ideal for Presentations, Approvals &amp; Marketing</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              From boardroom presentations to investor approvals and marketing campaigns, our visuals are optimized for every use case.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="reveal-item group flex items-start gap-5 sm:gap-6 py-6 border-b border-brand-border hover:bg-white/[0.02] transition-colors duration-300 cursor-default px-3" style="transition-delay: 400ms;">
          ...
          <div class="flex flex-col flex-1 pb-1">
            <h3 class="font-body font-medium text-white text-sm sm:text-base tracking-wider uppercase mb-1">Support for Residential, Commercial &amp; Mixed-Use Developments</h3>
            <p class="font-body text-gray-600 text-xs sm:text-sm leading-relaxed max-w-sm mt-1">
              From single-family homes to large-scale commercial complexes and mixed-use projects, our visualization services cover all property types.
            </p>
          </div>
          <div class="ml-auto text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all duration-300 flex-shrink-0 self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <section class="relative bg-brand-dark overflow-hidden py-24 md:py-36 px-5 sm:px-8 md:px-16 lg:px-24 border-t border-brand-border">
    ...
    <div class="relative z-10 max-w-7xl mx-auto flex flex-col items-center text-center gap-16">
      ...
      <h2 class="reveal-item font-display text-white leading-tight max-w-5xl" style="font-size: clamp(2.4rem, 5.5vw, 4.5rem); transition-delay: 80ms;">
        We transform architectural ideas into captivating visual stories that inspire confidence, support decision-making, and drive project success.
      </h2>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6 w-full">
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 0ms;">
          ...
          <p class="font-body text-gray-600 text-xs leading-relaxed">Uncompromising photorealistic quality that brings every project to life.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 80ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Precision</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Meticulous attention to lighting, materials, and architectural accuracy.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 160ms;">
          ...
          <p class="font-body text-gray-600 text-xs leading-relaxed">Compelling visuals that captivate stakeholders and accelerate approvals.</p>
        </div>
        ...
        <div class="pillar-card reveal-item border border-brand-border p-6 md:p-8 flex flex-col items-center text-center gap-4" style="transition-delay: 240ms;">
          ...
          <h4 class="font-body font-medium text-white text-xs tracking-[0.2em] uppercase">Clarity</h4>
          <p class="font-body text-gray-600 text-xs leading-relaxed">Clear visual communication that makes complex designs easy to understand.</p>
        </div>
  ...
  <section class="relative bg-white overflow-hidden py-20 md:py-28 px-5 sm:px-8 md:px-16 lg:px-24 flex flex-col items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center justify-center text-center gap-7">
      ...
      <h2 class="reveal-item font-display text-brand-dark leading-none" style="font-size: clamp(3rem, 7vw, 5.5rem); transition-delay: 80ms;">
        Ready to Showcase Your Project<br/>with Stunning Visuals?
      </h2>
  ...
  <section class="relative bg-brand-dark overflow-hidden py-24 md:py-32 px-8 md:px-16 lg:px-24 border-t border-brand-border">
    ...
    <div class="relative z-10 flex flex-col items-center text-center gap-6 max-w-7xl mx-auto mb-14 md:mb-16">
      ...
      <p class="reveal-item font-body text-gray-400 text-sm sm:text-base max-w-2xl leading-relaxed" style="transition-delay: 100ms;">
        Everything you need to know about architectural visualization.
      </p>
    </div>
    ...
    <div class="relative z-10 max-w-3xl mx-auto space-y-3 md:space-y-4">
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">What is architectural visualization?</span>
        ...
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Architectural visualization is the creation of photorealistic 3D renderings, animations, and virtual experiences that help clients visualize projects before construction.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">What architectural visualization services do you provide?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              We offer exterior renderings, interior renderings, aerial views, architectural walkthroughs, virtual tours, and master plan visualizations.
            </div>
          </div>
        </div>
      </details>
      ...
      <details class="faq-item group bg-[#0e0e0e] border border-brand-border rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
        <summary class="flex items-center justify-between gap-4 px-5 md:px-7 py-4 md:py-5 cursor-pointer text-white font-body text-sm md:text-base font-medium tracking-wide hover:text-brand-orange transition-colors duration-300">
          <span class="leading-snug">Do you create architectural walkthrough animations?</span>
          <svg class="faq-icon w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
          </svg>
        </summary>
        <div class="faq-content">
          <div>
            <div class="px-5 md:px-7 pb-4 md:pb-5 text-gray-400 font-body text-sm leading-relaxed border-t border-brand-border pt-4">
              Yes. We produce cinematic walkthroughs and flythrough animations for residential, commercial, and mixed-use developments.
            </div>
          </div>
        </div>
      </details>
